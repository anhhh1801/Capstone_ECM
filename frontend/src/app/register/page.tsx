    ...
    <div className="w-full max-w-md rounded-2xl bg-[var(--color-secondary)]/40 p-8 shadow-xl transition-all hover:shadow-2xl">
      ...
      <form className="space-y-6" onSubmit={handleRegister}>
        ...
        <button
          type="submit"
          disabled={loading}
          className={`w-full rounded-lg bg-[var(--color-main)] border-2 border-[var(--color-main)] px-5 py-3 font-medium text-white hover:bg-[var(--color-soft-white)] hover:text-[var(--color-main)] transition ${
