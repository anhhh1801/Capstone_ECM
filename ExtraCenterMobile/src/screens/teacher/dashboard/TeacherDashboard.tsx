...
const TeacherDashboard = () => {
    ...
    return (
        <SafeAreaView className="flex-1 bg-gray-50">
            ...
            >
                <Text className="text-2xl font-bold text-gray-800 mb-6">Overview</Text>
                    ...
                    <View className="flex-row flex-wrap justify-between mb-6">
                        {stats.map((stat, index) => (
                            <View
                                ...
                                className={`bg-white p-4 rounded-xl shadow-sm mb-4 flex-row items-center gap-3 ${index === 2 ? 'w-full' : 'w-[48%]'}`}
                            >
